...
export const certificates: Certificate[] = [
  {
    ...
    image: getDriveUrl(getAssetById('aws-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    image: getDriveUrl(getAssetById('tensorflow-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    image: getDriveUrl(getAssetById('azure-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    image: getDriveUrl(getAssetById('docker-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/442576/pexels-photo-442576.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    image: getDriveUrl(getAssetById('kubernetes-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/5082579/pexels-photo-5082579.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    image: getDriveUrl(getAssetById('react-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/7862662/pexels-photo-7862662.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    image: getDriveUrl(getAssetById('python-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    image: getDriveUrl(getAssetById('gcp-certificate')?.driveId || '', 'image') || 'https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=800',

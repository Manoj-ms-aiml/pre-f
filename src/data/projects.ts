...
export const projects: Project[] = [
  {
    ...
    images: [
      getDriveUrl(getAssetById('stickman-shootout-1')?.driveId || '', 'image') || 'https://images.pexels.com/photos/442576/pexels-photo-442576.jpeg?auto=compress&cs=tinysrgb&w=800',
      getDriveUrl(getAssetById('stickman-shootout-2')?.driveId || '', 'image') || 'https://images.pexels.com/photos/7862662/pexels-photo-7862662.jpeg?auto=compress&cs=tinysrgb&w=800'
    ],
    links: {
  ...
  },
  {
    ...
    images: [
      getDriveUrl(getAssetById('emotion-recognition-1')?.driveId || '', 'image') || 'https://images.pexels.com/photos/5082579/pexels-photo-5082579.jpeg?auto=compress&cs=tinysrgb&w=800',
      getDriveUrl(getAssetById('emotion-recognition-video')?.driveId || '', 'video') || 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800'
    ],
    links: {
  ...
  },
  {
    ...
    images: [
      getDriveUrl(getAssetById('breast-cancer-1')?.driveId || '', 'image') || 'https://images.pexels.com/photos/3913025/pexels-photo-3913025.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    images: [
      getDriveUrl(getAssetById('apollo-health-1')?.driveId || '', 'image') || 'https://images.pexels.com/photos/841130/pexels-photo-841130.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    images: [
      getDriveUrl(getAssetById('astro-santhvana-1')?.driveId || '', 'image') || 'https://images.pexels.com/photos/6980516/pexels-photo-6980516.jpeg?auto=compress&cs=tinysrgb&w=800',
